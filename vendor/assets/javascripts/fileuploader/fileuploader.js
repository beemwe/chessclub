...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        listElement: null,
        dragText: 'Bilder vom Explorer hier fallen lassen.',
        uploadButtonText: 'Bild(er) hochladen',
        cancelButtonText: 'Abbrechen',
        failUploadText: 'Fehler beim Hochladen',
        hideShowDropArea: false,

        template: '<div class="qq-uploader">' +
            '<div id="inner-image-area" class="qq-upload-drop-area"><span>{dragText}</span></div>' +
            '<div class="qq-upload-button btn" style="display:inline">{uploadButtonText}</div>' +
